...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ('short_text', 'student_info', 'mentor', 'is_answered', 'created_at')
    list_filter = ('mentor', 'is_answered', 'created_at')
    search_fields = ('text', 'student__first_name', 'student__last_name', 'student__username')
    readonly_fields = ('created_at', 'student')
