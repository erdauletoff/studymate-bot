TEXTS = {
    "ru": {
        ...
        "message_not_delivered": "⚠️ Не удалось доставить сообщение ученику {name}",
        "mentor_message": "✉️ <b>Сообщение от вашего ментора:</b>\n\n{text}",
        "student_not_found": "❌ Ученик не найден",
        "btn_message_all": "Написать всем",
        "btn_confirm": "Подтвердить",
        "write_broadcast_message": "📢 Напишите сообщение для <b>всех учеников</b> ({count} чел.):",
        "sending_broadcast": "📤 Отправка... {sent}/{total}",
        "broadcast_complete": "✅ Сообщение отправлено {sent} ученикам!",
        "broadcast_complete_partial": "⚠️ Отправлено: {sent}, не доставлено: {failed}",
        ...
        "btn_view_all_questions": "📋 Все вопросы",
        "btn_back_to_preview": "⬅️ Назад к превью",
        "quiz_all_questions_header": "📋 <b>Все вопросы ({current}/{total})</b>\n\n",
        "quiz_question_item": "<b>{num}.</b> {text}\n   A) {a}\n   B) {b}\n   C) {c}\n   D) {d}\n   ✅ Ответ: <b>{correct}</b>\n\n",
    ...
    "qq": {
        ...
        "message_not_delivered": "⚠️ {name} oqıwshıǵa xabar jiberilmedi",
        "mentor_message": "✉️ <b>Mentordan xabar:</b>\n\n{text}",
        "student_not_found": "❌ Oqıwshı tabilmadı",
        "btn_message_all": "Barlıgına jazıw",
        "btn_confirm": "Tastıyıqlaw",
        "write_broadcast_message": "📢 <b>Barlıq oqıwshılar</b> ushın xabar jazıń ({count} adam):",
        "sending_broadcast": "📤 Jiberiliwde... {sent}/{total}",
        "broadcast_complete": "✅ Xabar {sent} oqıwshıǵa jiberildi!",
        "broadcast_complete_partial": "⚠️ Jiberildi: {sent}, jiberilmedi: {failed}",
        "back_to_menu": "↩️ Menyuge qaytıw",
        ...
        "btn_view_all_questions": "📋 Barlıq sorawlar",
        "btn_back_to_preview": "⬅️ Aldınǵı betke",
        "quiz_all_questions_header": "📋 <b>Barlıq sorawlar ({current}/{total})</b>\n\n",
        "quiz_question_item": "<b>{num}.</b> {text}\n   A) {a}\n   B) {b}\n   C) {c}\n   D) {d}\n   ✅ Juwap: <b>{correct}</b>\n\n",
    ...
    "en": {
        ...
        "message_not_delivered": "⚠️ Could not deliver message to {name}",
        "mentor_message": "✉️ <b>Message from your mentor:</b>\n\n{text}",
        "student_not_found": "❌ Student not found",
        "btn_message_all": "Message All",
        "btn_confirm": "Confirm",
        "write_broadcast_message": "📢 Write a message for <b>all students</b> ({count} people):",
        "sending_broadcast": "📤 Sending... {sent}/{total}",
        "broadcast_complete": "✅ Message sent to {sent} students!",
        "broadcast_complete_partial": "⚠️ Sent: {sent}, failed: {failed}",
        ...
        "btn_view_all_questions": "📋 All questions",
        "btn_back_to_preview": "⬅️ Back to preview",
        "quiz_all_questions_header": "📋 <b>All questions ({current}/{total})</b>\n\n",
        "quiz_question_item": "<b>{num}.</b> {text}\n   A) {a}\n   B) {b}\n   C) {c}\n   D) {d}\n   ✅ Answer: <b>{correct}</b>\n\n",
